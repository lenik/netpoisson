...
.\build.ps1 -Name netpoisson -Version 1.2.3
```
...
```
<project>/.config/netpoisson/<packaging>.build-host
$HOME/.config/netpoisson/<packaging>.build-host
```
